...
function dataMarkupAll(data) {
  ...
  //   const dataMarkupAll = booksData
  //     .map((bookData) => {
  //       return `
  //       <a href="">
  //       <li><img src="${bookData.books[0].book_image}" width='180px' height='256px' alt="${bookData.books[0].title}"><h3>${bookData.books[0].title}</h3><p>${bookData.books[0].author}</p></li>
  //   </a>`;
  //     })
  //     .join(" ");
